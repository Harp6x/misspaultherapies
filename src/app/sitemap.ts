...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/tools/check-in`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/burnout-quiz`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/reflect`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/journal`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/self-awareness`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/relationship-reflect`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    ...
    // LLM discovery files
    { url: `${base}/llms.txt`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/llms-full.txt`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  ];
