...
export const siteConfigSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "general",
      description:
        "Upload 4–6 photos for the homepage hero slideshow. Therapy room, Aishani's photo, calming nature, etc.",
      of: [
        {
          type: "object",
          fields: [
    ...
    defineField({
      ...
      options: { hotspot: true },
      description:
        "Soft background image for the How It Works section. Use a calm nature/plant photo.",
    }),
    ...
    defineField({
      name: "sessionBookingUrl",
      title: "Session Booking URL",
      type: "url",
      group: "contact",
    }),
    defineField({ name: "workingHours", title: "Working Hours", type: "string", group: "contact" }),
    defineField({
      name: "upiId",
      title: "UPI ID",
      type: "string",
    ...
    defineField({
      ...
      type: "string",
      group: "newsletter",
      description: "The data-uid value from your Kit embed snippet, e.g. 1d5b37459d.",
    }),
    defineField({
      name: "kitScriptUrl",
      ...
      group: "newsletter",
      description:
        "The full src URL from your Kit embed snippet, e.g. https://ms-paul-therapies.kit.com/1d5b37459d/index.js.",
    }),

    // ── Page Visibility Toggles ──
    defineField({
      name: "enableBlogPage",
      title: "Enable Blog Page",
      type: "boolean",
      initialValue: true,
      group: "pages",
      description: "Toggle the Blog page on/off.",
    }),
    defineField({
      name: "enableProductsPage",
      title: "Enable Products Page",
      type: "boolean",
      initialValue: true,
      group: "pages",
      description: "Toggle the Products page on/off.",
    }),
    defineField({
      name: "enableWorkshopsPage",
      title: "Enable Workshops Page",
      type: "boolean",
      initialValue: true,
      group: "pages",
      description: "Toggle the Workshops page on/off.",
    }),
    defineField({
      ...
      initialValue: true,
      group: "pages",
      description: "Toggle the Gallery page on/off.",
    }),
    defineField({
      name: "enableResourcesPage",
      title: "Enable Resources Page",
      type: "boolean",
      initialValue: true,
      group: "pages",
      description: "Toggle the Resources page on/off.",
    }),
    ...
    tagArray(
      "blogCategories",
      "Blog Categories",
      "Options for the Blog category dropdown (e.g. Mental Health, Relationships)"
    ),
    tagArray(
      "faqCategories",
      "FAQ Categories",
      "Options for the FAQ category dropdown (e.g. Getting Started, Sessions)"
    ),
    tagArray(
      "productTypes",
      "Product Types",
      "Options for the Product type dropdown (e.g. Worksheet, eBook, Course)"
    ),
    tagArray(
      "productTopics",
      "Product Topics",
      "Options for the Product topic dropdown (e.g. Anxiety, Self-Care)"
    ),
    tagArray(
      "productAudiences",
      "Product Audiences",
      "Options for the Product audience dropdown (e.g. Adults, Couples)"
    ),
    tagArray(
      "workshopStatuses",
      "Workshop Statuses",
      "Options for the Workshop status dropdown (e.g. Upcoming, Open, Sold Out)"
    ),
  ],
  preview: {
    prepare() {
